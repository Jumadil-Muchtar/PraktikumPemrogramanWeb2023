...
<body>
  ...
  <a href="tambah.php" class="add"><img src="data:image/png;base64," /> Add</a>
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th scope="col" style="padding: 10px 40px; background-color:#4A9DEC;">Aksi</th>
        </tr>
      </thead>
      ...
      <tbody class="table-group-divider">
        ...
        <?php foreach ($mahasiswa as $row) : ?>
          <tr>
            ...
            <td><?= $row["fakultas"] ?></td>
            <td><?= $row["jurusan"] ?></td>
            <td><a href="ubah.php?id=<?= $row["id"] ?>"><i class='bx bx-edit-alt'></i></a> |
              <a href="hapus.php?id=<?= $row["id"] ?>" onclick="return confirm('Apakah anda yakin?');"><i class='bx bx-trash'></i></a>
            </td>
            <?php $i++; ?>
          <?php endforeach; ?>
      </tbody>
