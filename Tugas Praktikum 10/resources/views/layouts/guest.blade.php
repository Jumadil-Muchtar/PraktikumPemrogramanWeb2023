...
<head>
    ...
    <title>{{ config('app.name', 'ZenithCare') }}</title>
...
<body class="antialiased bg-white font-sans text-gray-900">
    ...
    <section
        class="px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-400 to-green-400">
