<footer class="relative bg-teal-600 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
    <div class="flex flex-col md:flex-row">
        <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
            <h3 class="font-bold text-2xl">ZenithCare Hospital</h3>
        </div>

        <div class="w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8">
            <h5 class="uppercase tracking-wider font-semibold text-black-500">
                Contact Details
            </h5>
            <ul class="mt-4">
                <li>
                ...
                <li class="mt-4">
                    <a href="#" title="" class="flex items-center opacity-75 hover:opacity-100">
                        ...
                        <span class="ml-3"> +62 851 2345 6789 </span>
                    </a>
                </li>
                <li class="mt-4">
                    <a href="#" title="" class="flex items-center opacity-75 hover:opacity-100">
                        ...
                        <span class="ml-3"> zenithcare@gmail.com </span>
                    </a>
                </li>
            </ul>
        </div>
