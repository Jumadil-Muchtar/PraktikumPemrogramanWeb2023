      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        <div class="navbar-header">
          <!-- Navbar Header--><a href="index.html" class="navbar-brand">
            <div class="brand-text brand-big visible text-uppercase"><strong class="text" style="color: #001B79">Siloam</strong><strong style="color: #03C988">Hospital</strong></div>
            <div class="brand-text brand-sm"><strong class="text" style="color: #001B79">S</strong><strong style="color: #03C988">H</strong></div></a>
          <!-- Sidebar Toggle Btn-->
        ...
        <form method="POST" action="{{ route('logout') }}"  id="logoutForm">
          @csrf
          <button type="submit"  style="color: #001B79; border:none; background-color:#fff; font-size:30px;" onclick="confirmLogout()"><i class="bi bi-box-arrow-left"></i></button>
      </form>
