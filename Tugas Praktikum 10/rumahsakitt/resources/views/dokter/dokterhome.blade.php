      ...
      <div class="page-content" style="background-color: #fff">
        <div class="page-header" style="background-color: #fff">
          <div class="container-fluid">
            <h2 class="h1 no-margin-bottom" style="color: #001B79">Dashboard</h2>
          </div>
        </div>
        <section class="no-padding-top no-padding-bottom" style="background-color: #fff">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block" style="background-color: #001B79">
                  <div class="progress-details d-flex align-items-end justify-content-between" >
                    <div class="title">
                      <div class="icon"><i class="icon-user-1" style="color: #fff"></i></div><strong style="color: #fff">Pasien</strong>
                    </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block" style="background-color: #001B79">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract" style="color: #fff"></i></div><strong style="color: #fff">New Projects</strong>
                    </div>
                    <div class="number dashtext-1">375</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block" style="background-color: #001B79">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil" style="color: #fff"></i></div><strong style="color: #fff">New Invoices</strong>
                    </div>
                    <div class="number dashtext-1">140</div>
                  </div>
                  <div class="progress progress-template">
                    <div role="progressbar" style="width: 55%" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template dashbg-1"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block" style="background-color: #001B79">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard" style="color: #fff"></i></div><strong style="color: #fff">All Projects</strong>
                    </div>
                    <div class="number dashtext-1">41</div>
                  </div>
                  <div class="progress progress-template">
        ...
        <section class="no-padding-bottom" >
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
                <div class="bar-chart block no-margin-bottom" style="background-color: #fff">
                  <canvas id="barChartExample1"></canvas>
                </div>
                <div class="bar-chart block" style="background-color: #fff">
                  <canvas id="barChartExample2"></canvas>
                </div>
              </div>
              <div class="col-lg-8">
                <div class="line-cahrt block" style="background-color: #fff">
        ...
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="stats-2-block block d-flex" style="background-color: #fff">
                  ...
                  <div class="stats-2 d-flex" style="background-color: #fff">
                ...
                <div class="stats-3-block block d-flex" style="background-color: #fff">
              ...
              <div class="col-lg-6">
                <div class="drills-chart block" style="background-color: #fff">
